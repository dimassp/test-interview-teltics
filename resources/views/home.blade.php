...
<body>
    <div class="navbar d-flex justify-content-between w-100 p-0 m-0">
        <div class="d-flex justify-content-center align-items-center rectangle-100px">
            <img class="object-fit-scale" src="{{asset('assets/images/white logo united creative.png')}}" alt="" style="object-fit: cover; height: 75px; width: 75px;">
        </div>
        <div class="d-flex justify-content-center align-items-center rectangle-100px">
            <li class="larger bi bi-list text-white"></li>
        </div>
    </div>
    ...
    <main>
                        ...
                        <div class="d-flex flex-row">
                            <div
                                ...
                                <div class="d-flex justify-content-center align-items-center w-100">
                                    <img class="d-block w-100 c-img object-fit-contain rectangle-100px"src="{{ asset($product->product_logo) }}" alt="">
                                </div>
                            </div>
                        @else
                            @if ($i % 3 != 0)
        ...
        <div id="differentiation-carousel" class="carousel slide position-relative" data-bs-ride="carousel">
            <div class="carousel-indicators d-flex position-absolute bottom-0 m-0 p-0" style="height: 15px;">
                <button type="button" data-bs-target="#differentiation-carousel" data-bs-slide-to="0"
                        ...
                        <div class="d-flex flex-row">
                            <div
                                ...
                                <div
                                    class="top-0 left-0 p-2 reguler product-card  position-absolute letter-space-normal fw-bolder d-flex align-items-end">
                                    <span
                                        class="product-text-color above">{{ strtoupper($service->service_name) }}</span>
                                </div>
                                <div class="d-flex justify-content-center align-items-center w-100">
                                    @if (is_null($service->service_logo))
                                        <img class="d-block w-100 c-img object-fit-contain"
                                            src="{{ asset('assets/images/no-image.png') }}" alt=""
                                            style="height: 100%; width: 100px;">
                                    @else
                                        <img class="d-block w-100 c-img " src="{{ asset($service->service_logo) }}"
                                    ...
                                    <div class="d-flex justify-content-center align-items-center w-100">
                                        ...
                                        @else
                                            <img class="d-block w-100 c-img "
                                                src="{{ asset($service->service_logo) }}" alt=""
        ...
        <div id="works-carousel" class="carousel slide" data-bs-ride="false">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#works-carousel" data-bs-slide-to="0" class="active"
                    aria-current="true" aria-label="Slide 1"></button>
                <button type="button" data-bs-target="#works-carousel" data-bs-slide-to="1"
                    aria-label="Slide 2"></button>
                <button type="button" data-bs-target="#works-carousel" data-bs-slide-to="2"
                    aria-label="Slide 3"></button>
            </div>
            <div class="carousel-inner">
                <div class="carousel-item active h-100">
                    <div class="d-flex align-items-center justify-content-center h-100 p-3">
                        <div class="m-3" style="height: 200px; width: 200px;">
                            <img class="w-100 h-100 object-fit-cover" src="{{asset('assets/images/v691_2372.png')}}" alt="">
                        </div>
                        <div class="m-3" style="height: 200px; width: 200px;">
                            <img class="w-100 h-100 object-fit-cover" src="{{asset('assets/images/v691_2366.png')}}" alt="">
                        </div>
                        <div class="m-3" style="height: 200px; width: 200px;">
                            <img class="w-100 h-100 object-fit-cover" src="{{asset('assets/images/v733_1558.png')}}" alt="">
                        </div>
                    </div>
                </div>
            ...
            <button class="carousel-control-prev" type="button" data-bs-target="#works-carousel"
                data-bs-slide="prev">
                <h3><span class="bi bi-arrow-left-circle" aria-hidden="true"></span></h3>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#works-carousel"
                data-bs-slide="next">
                <h3><span class="bi bi-arrow-right-circle" aria-hidden="true"></span></h3>
                <span class="visually-hidden">Next</span>
            </button>
            ...
            @foreach ($clients as $client)
                ...
                @if ($isNewRow)
                    ...
                    <div class="d-flex flex-row align-items-center justify-content-center">
                        <div
                            class="col-1 m-3 position-relative d-flex justify-content-start ">
                            <div
                                class="top-0 left-0 p-2 reguler position-absolute letter-space-normal fw-bolder d-flex align-items-end">
                            </div>
                            <div class="d-flex justify-content-center align-items-center h-75 w-100">
                                @if (is_null($client->client_logo))
                                    <img class="d-block h-75 w-100s object-fit-contain"
                                        src="{{ asset('assets/images/no-image.png') }}" alt=""
                                        style="height: 100%; width: 100px;">
                                @else
                                    <img class="d-block h-75 w-100s " src="{{ asset($client->client_logo) }}"
                                        alt="" style="height: 100%; width: 100%;">
                                @endif
                            </div>
                        </div>
                    @else
                        @if ($i % 7 != 0)
                            <div
                                ...
                                <div class="d-flex justify-content-center align-items-center w-100">
                                    @if (is_null($client->client_logo))
                                        <img class="d-block w-100 object-fit-contain"
                                            src="{{ asset('assets/images/no-image.png') }}" alt=""
                                            style="height: 100%; width: 100px;">
                                    @else
                                        <img class="d-block w-100 "
                                            src="{{ asset($client->client_logo) }}" alt=""
                                            style="height: 100%; width: 100%;">
                                    @endif
                                </div>
                            </div>
